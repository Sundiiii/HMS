...
public class updatepatientrecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(2, 8));
        ...
        jLabel8.setText("Any Mejor Disease Suffered Earliar ");
...
String bloodgrup=jTextField7.getText();
String address=jTextField8.getText();
String anymejordisease=jTextField9.getText();
try{
     Connection con=  connectionprovider.getCon();
   Statement sst=  con.createStatement();
    sst.executeUpdate("update patient  set name='"+name+"',contactnumber='"+contactno+"',age='"+age+"',"
     + "gender='"+gender+"',bloodgroop='"+bloodgrup+"',address='"+address+"',"
             + "anymajordisease='"+anymejordisease+"' where patientid='"+patientid+"' ");      
